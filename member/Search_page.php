...
<!DOCTYPE html>
<!-- saved from url=(0053)https://openlibrary.org/search?q=Game&mode=everything -->
...
<head>
    ...
    <link rel="canonical" href="https://openlibrary.org/search?q=Game">
    ...
    <link href="./Search_page_files/page-user.css" rel="stylesheet" type="text/css">
    ...
    <title>Search page || Ta Quang Buu Library</title>
...
<body class="client-js">
    ...
    <script>
        $(document).ready(function() {
            // Retrieve the filter and information from the URL parameters
            var params = new URLSearchParams(window.location.search);
            var filter = params.get('filter');
            var information = params.get('information');

            // Perform AJAX request to send the data to PHP script
            $.ajax({
    ...
    <div id="topNotice">
        <div class="page-banner page-banner-black page-banner-center">
            <div class="iaBar">
                <a class="iaLogo" href="https://archive.org/"><img alt="Internet Archive logo" src="./Search_page_files/ia-logo.svg" width="160"></a>     
            </div>
        </div>
    </div>
</div>
...
<!-- results -->
    ...
    <div class="resultsContainer search-results-container">
        <div id="searchResults">
            <ul id="resultList" class="list-books">   
